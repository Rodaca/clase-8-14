"use strict";
class Centro {
    constructor(object_id, nombre, descripción, estado, ciudad) {
...
class Ruta {
    constructor(ObjectId, nombre, centro) {
...
class Nivel {
    constructor(objectId, nombre, ruta, duración) {
        this.objectId = objectId;
        this.nombre = nombre;
        this.ruta = ruta;
...
class Camper {
    constructor(objectId, nombre, típoIdentificacion, NroIdentificacion, email, password, level, levelState, estado, imagen, promedio, centro) {
        this.objectId = objectId;
        this.nombre = nombre;
        this.típoIdentificacion = típoIdentificacion;
    ...
    contarCentros() {
        ...
        let nom1 = "Centro IT Innovate", nom2 = "Academia CodeTech", nom3 = "Instituto DigitalTech", nom4 = "Centro Informático ByteMaster", nom5 = "Escuela TechCode", nom6 = "Academia CodeWave", nom7 = "Instituto IT Future";
        let nombreM = "";
        let nombrem = "";
        let valorM = 0;
        let valorm = 10000000;
        camperes.forEach(element => {
            ...
            let variables = [var1, var2, var3, var4, var5, var6, var7];
            let nombres = [nom1, nom2, nom3, nom4, nom5, nom6, nom7];
...
class Contrato {
    constructor(object_id, nombre, descripción, estado, tipoContrato, camper //en vez de usar  Camper.object_id usaria Camper.NroIdentificacion
    ) {
        this.object_id = object_id;
        this.nombre = nombre;
        this.descripción = descripción;
